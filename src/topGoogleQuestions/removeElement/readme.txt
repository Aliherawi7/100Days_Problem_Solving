...
new length. Do not allocate extra space for
another array, you must do this by modifying the
...
and 4. Note that the order of those five elements
can be arbitrary. It doesn't matter what values are
...
which means modification to the input array will be
